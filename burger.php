...
$sql = "SELECT * FROM recipes WHERE name = 'Classic Burger'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // Output data of the first row (assuming there's only one burger recipe)
...
<body>
    ...
    <iframe src="https://www.youtube.com/embed/BIG1h2vG-Qg" frameborder="0" allowfullscreen></iframe>
    <h2><?php echo $name; ?></h2>
