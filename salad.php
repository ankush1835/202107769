...
$sql = "SELECT * FROM recipes WHERE name = 'Garden Salad'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // Output data of the first row (assuming there's only one salad recipe)
...
<html lang="en">
<head>
    <title>Garden Salad Recipe</title>
...
<body>
    ...
    <iframe src="https://www.youtube.com/embed/bMactSaZWfU" frameborder="0" allowfullscreen></iframe>
    <h2><?php echo $name; ?></h2>
